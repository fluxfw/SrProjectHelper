...
```php
\srag\DIC\SrProjectHelper\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrProjectHelper\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrProjectHelper\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
