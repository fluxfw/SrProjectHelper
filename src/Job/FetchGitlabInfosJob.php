...
class FetchGitlabInfosJob extends ilCronJob
{
    ...
    public function run() : ilCronJobResult
    {
        ...
        $ilias_versions = array_reduce(array_filter(Api::pageHelper(function (array $options) : array {
            return self::srProjectHelper()->gitlab()->repositories()->branches(self::srProjectHelper()->config()->getField(ConfigFormGUI::KEY_GITLAB_ILIAS_PROJECT_ID), $options
        ...
        self::srProjectHelper()->config()->setField(ConfigFormGUI::KEY_GITLAB_ILIAS_VERSIONS, $ilias_versions);

        $plugins = array_reduce(Api::pageHelper(function (array $options) : array {
            return self::srProjectHelper()->gitlab()->groups()->projects(self::srProjectHelper()->config()->getField(ConfigFormGUI::KEY_GITLAB_PLUGINS_GROUP_ID), $options + [
                    "simple" => true
                ]);
        ...
        self::srProjectHelper()->config()->setField(ConfigFormGUI::KEY_GITLAB_PLUGINS, $plugins);
        ...
        self::srProjectHelper()->config()->setField(ConfigFormGUI::KEY_GITLAB_GROUPS, $groups);

        $users = array_reduce(Api::pageHelper(function (array $options) : array {
            return self::srProjectHelper()->gitlab()->groups()->members(self::srProjectHelper()->config()->getField(ConfigFormGUI::KEY_GITLAB_MEMBERS_GROUP_ID), $options);
        ...
        self::srProjectHelper()->config()->setField(ConfigFormGUI::KEY_GITLAB_USERS, $users);
        ...
        self::srProjectHelper()->config()->setField(ConfigFormGUI::KEY_GITLAB_PROJECTS, $projects);
